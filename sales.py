...
file_path = r"C:/Users/Anuratna pandey/Desktop/project/sales forcast/train.csv"
...
sales_with_lags = sales_with_lags.dropna().reset_index(drop=True)
...
plt.figure(figsize=(12, 6))
plt.plot(range(len(y_test)), y_test, label='Actual Sales', color='red')
plt.plot(range(len(predictions_xgb)), predictions_xgb, label='Predicted Sales', color='green')
